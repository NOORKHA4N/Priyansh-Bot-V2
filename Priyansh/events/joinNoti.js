...
module.exports.run = async function({ api, event }) {
	...
	if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
		...
		const fs = require("fs");
		return api.sendMessage("𝐇𝐄𝐋𝐋𝐎 𝐄𝐕𝐄𝐑𝐘𝐎𝐍𝐄🙋‍♂️", event.threadID, () => api.sendMessage({body:`🌺𝐒𝐀𝐌𝟑𝟑𝐑  𝐁𝐎𝐓🦋🌺 𝐂𝐎𝐍𝐍𝐄𝐂𝐓𝐄𝐃«

𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐛𝐲𝐞 𝐒𝐀𝐌𝟑𝟑𝐑 𝐊𝐇𝐀𝐍☘️
<------------------------------>  
...
𝐎𝐖𝐍𝐄𝐑: 𝐌𝐑.𝐒𝐀𝐌𝐄𝐄𝐑 𝐊𝐇𝐀𝐍

♻️Facebook: 

https://www.facebook.com/SAMEER.SHARABI.HERE

Youtube Site : https://youtube.com/@sameeraawara

☢️Telegram: N/A

☣️Email: adnaann05@gmail.com

⚠️Wp: 6009815052`, attachment: fs.createReadStream(__dirname + "/cache/instagram_1753054441099(720p).mp4")} ,threadID));
	}
	else {
		try {
